...
#import "UILabel+QYAutoSize.h"

@implementation UILabel (QYAutoSize)
- (UILabel *)resizeLabelHorizontal { return [self resizeLabelHorizontal:0]; }
- (UILabel *)resizeLabelVertical { return [self resizeLabelVertical:0]; }
- (UILabel *)resizeLabelVertical:(CGFloat)minimumHeigh
{
    ...
    if ([text respondsToSelector:@selector(boundingRectWithSize:options:attributes:context:)])
    {
        ...
        size = [text boundingRectWithSize:constrainedSize
